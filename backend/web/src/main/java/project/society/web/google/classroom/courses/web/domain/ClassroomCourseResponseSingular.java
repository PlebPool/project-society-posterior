...
public class ClassroomCourseResponseSingular implements ClassroomResponseType {
  ...
  public ClassroomCourseResponseSingular(
      String id, String name, String descriptionHeading, String courseState) {
    this.id = id;
    this.name = name;
  ...
  public boolean equals(Object o) {
    ...
    return id.equals(that.id)
        ...
        && Objects.equals(descriptionHeading, that.descriptionHeading)
        && Objects.equals(courseState, that.courseState);
  }
