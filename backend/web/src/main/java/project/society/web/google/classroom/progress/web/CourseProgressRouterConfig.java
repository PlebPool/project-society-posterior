...
public class CourseProgressRouterConfig {
  ...
  public RouterFunction<ServerResponse> courseProgressRouter(
    ...
    return RouterFunctions.route(
            GET("/classroom/courses/{courseId}/progress"),
            courseProgressHandler::getCourseProgressById)
        .andRoute(
            GET("/classroom/courses/progress"), courseProgressHandler::getCourseProgressForUser);
  }
}
