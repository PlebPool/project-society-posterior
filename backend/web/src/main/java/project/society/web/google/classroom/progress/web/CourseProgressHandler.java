...
public class CourseProgressHandler {
    ...
    public Mono<ServerResponse> getCourseProgressById(ServerRequest request) {
        return this.classroomService
                .getResponseMono("/courses/" + request.pathVariable("courseId"),
                        request, ClassroomCourseResponseSingular.class)
    ...
    private Mono<CourseProgress> calculateCourseProgress(ClassroomCourseResponseSingular course, ServerRequest request) {
        return this.classroomService
                .getResponseMono("/courses/" + course.getId() + "/courseWork",
                        request, ClassroomCourseWorkResponsePlural.class)
    ...
    private Flux<Boolean> courseWorkIsHandedIn(String courseId, String courseWorkId, ServerRequest request) {
        return this.classroomService
                .getResponseMono("/courses/" + courseId + "/courseWork/" + courseWorkId + "/studentSubmissions",
                        request, ClassroomStudentSubmissionResponsePlural.class)
