...
//    @Bean
//    public MySqlReactiveSessionRepository mySqlReactiveSessionRepository(R2dbcEntityTemplate
// r2dbcEntityTemplate, Environment e) {
//        return new MySqlReactiveSessionRepository(new SessionDAOService(new
// GenericReactiveDAO(r2dbcEntityTemplate)), e);
//    }
// }
