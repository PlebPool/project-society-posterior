...
public class CustomizedMapSession implements Session, HasId<String> {
  ...
  /**
   * Creates a new instance with the specified id. This is preferred to the default constructor when
   * the id is known to prevent unnecessary consumption on entropy which can be slow.
   *
  ...
  /**
   * Generates and sets a new id for this. It also returns the id.
   *
   * @return {@link String}
   */
  @Override
  ...
  /**
   * Sets the time that this {@link Session} was created. The default is when the {@link Session}
   * was instantiated.
   *
  ...
  /**
   * Sets the identifier for this {@link Session}. The id should be a secure random generated value
   * to prevent malicious users from guessing this value. The default is a secure random generated
   * identifier.
   *
